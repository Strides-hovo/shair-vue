<template>
    ...
    <div class="container-content">
        ...
        <div class="container-content__body">
            ...
            <Modal v-if="new_lang_modal" @CloseModal="closeModal" :is-active="new_lang_modal">
            ...
            <table class="orders">
                <thead>
                    ...
                    <tr>
                        <td>
                            <label>
                                <input type="checkbox" @change="selectAllLanguages" v-model="all_checked"
                                    :checked="all_checked">
                ...
                <tbody>
                    <tr class="order-row unwatched" v-for="lang of languages" :key="lang.id">
                        <td>
                            <label>
                                <input type="checkbox" @change="selectLanguage" :value="lang.id" v-model="languageIds">
                                <span class="fake"></span>
                            </label>
                        </td>
                        <td>{{ lang.name }}</td>
